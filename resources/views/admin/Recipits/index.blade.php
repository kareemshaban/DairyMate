...
<style>
    tfoot td {
    border-top: 2px solid #566a7f !important; /* خط فاصل سميك قبل الإجمالي */
    font-size: 14px;
    font-weight: bold;
}
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <!-- Responsive Table -->
                    <div class="card">
                        <h5 class="card-header">{{__('main.recipit_list')}}</h5>
                        ...
                        <div class="table-responsive  text-nowrap">
                            <table class="table table-striped table-hover">
                                ...
                                <tfoot class="table-dark">
                                    <tr>
                                        <td colspan="5" class="text-end fw-bold" style="text-align: left !important;">{{__('main.total')}} :</td>
                                        <td class="text-center fw-bold" style="background-color: #e1f5fe; color: #01579b;">
                                            {{ number_format($docs->sum('amount'), 2) }}
                                        </td>
                                        <td colspan="2"></td>
                                    </tr>
                                </tfoot>
...
@include('admin.Recipits.view')
@include('admin.Recipits.deleteModal')
...
<script type="text/javascript">
            ...
            success:function(response){
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        const supplierSelect = choicesInstances['supplier_id'];
                        supplierSelect.setChoiceByValue("");

                        const safeSelect = choicesInstances['safe_id'];
                        safeSelect.setChoiceByValue(response.safe.id.toString());
                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                           ...
                           // $(".modal-body #supplier_id").val( response.supplier_id );
                            ...
                            const supplierSelect = choicesInstances['supplier_id'];
                            supplierSelect.setChoiceByValue(supplierId.toString());
    ...
    function confirmDelete(id){
        let url = "{{ route('deleteRecipit', ':id') }}";
    ...
    function postDoc(id){
        ...
        let url = "{{ route('post_recipit_doc', ':id') }}";
        url = url.replace(':id', id);
        document.location.href=url;
