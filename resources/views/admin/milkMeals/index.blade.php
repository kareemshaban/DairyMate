                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <div style="display: flex ; justify-content: space-between ; align-items: center">
                        <h4 class="fw-bold py-3 mb-4">
                            <span class="text-muted fw-light">{{__('main.milk_department')}} /</span> {{__('main.milk_meals')}}
                        </h4>
                    ...
                    <!-- Responsive Table -->
                    <div class="card">
                        <h5 class="card-header">{{__('main.milk_meals')}}</h5>
...
<script>
    ...
    function getMeals(month, year, day, id) {
        ...
        $.ajax({
            type: 'GET',
            url: `/getWeaklyMeals/${month}/${year}/${day}`,
            dataType: 'json',
            ...
            success: function (meals) {
                ...
                if (meals.length > 0) {
                    if (meals[0].state == 0) {
                        ...
                        span.textContent = "{{ __('main.mealState0') }}";
                    } else {
                        span.classList.add('bg-danger');
                        span.textContent = "{{ __('main.mealState1') }}";
                    }
